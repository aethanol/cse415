...
ethan = Partner("Anderson", "Ethan", "aethan")
bart = Partner("Bartholomew", "Olson", "NA")
team = [ethan, bart]

problem1 = Problem("Cognitive Radios for CubeSats", 'wicked', "Cognitive_Radio")
 # In this case, the Python file for the formulation would be named End_Poverty.py.

problems = [problem1]

our_submission = Who_and_what([ethan, bart], OPTION_A, problems)
